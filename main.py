...
async def on_voice_state_update(member: discord.Member, before: discord.VoiceState, after: discord.VoiceState):
    if after.channel is not None and after.channel.id == 735889079446536242:
    ...
    if after.channel is not None and after.channel.id == 735889254877626498:
        category: discord.CategoryChannel = discord.utils.get(member.guild.categories, id=554265879463067659)
    ...
    try:
        if after.channel is None and not before.channel.id == 735889079446536242 or after.channel \
                is None and not before.channel.id == 735889254877626498:
